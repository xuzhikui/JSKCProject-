...
- (id)initWithText:(NSString*)text
{
    ...
    if (self) {
        ...
        CGSize textSize = [_text sizeWithFont:font constrainedToSize:CGSizeMake(280*Width1, 60*Height1)];
        //leak;
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(10, 5, textSize.width, textSize.height)];
//         UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(10, Height-100, Width, textSize.height)];
        ...
        rect.origin = CGPointMake((Width-rect.size.width)/2, Height-200*Height1);
        self.layer.cornerRadius = 5;
        self.layer.masksToBounds = YES;
        [self showWithType:ShortTime];
        [self setFrame:rect];
