...
#import "DFDisplayView.h"


@interface DFDisplayView ()<UIScrollViewDelegate>
{
...
@implementation DFDisplayView

-(instancetype)initWithFrame:(CGRect)frame
{
    self = [super initWithFrame:frame];
    if (self) {
        _imageArray = [@[@"启动页_1",@"启动页-2", @"启动页-3",@"启动页-4"]mutableCopy];
