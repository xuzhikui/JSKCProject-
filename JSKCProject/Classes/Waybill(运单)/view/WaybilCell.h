...
typedef void(^delegateBlock)(NSDictionary *code);
@interface WaybilCell : UITableViewCell
...
@property(nonatomic,strong)delegateBlock removeBlock;
@property(nonatomic,strong)delegateBlock endBlock;
@property(nonatomic,strong)delegateBlock block;
@property(nonatomic,strong)NSString *type;
@property(nonatomic,copy) void (^endSendWayBlock)(void);
@end
