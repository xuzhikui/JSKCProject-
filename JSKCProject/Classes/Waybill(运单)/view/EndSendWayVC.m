...
//    [UILabel initWithDFLable:CGRectMake(22, 70, 200, 30) :[UIFont systemFontOfSize:15*Width1] :COLOR2(51) :@"实际发货时间" :back :0];
//
//    self.selectTimeBut = [UIButton initWithFrame:CGRectMake(Width - 170, 70, 135, 30) :@"请选择实际发货时间" :11];
...
//
//
//    UIButton *imgBut = [UIButton initWithFrame:CGRectMake(Width - 30, 75, 12, 20) :@"返 回 拷贝 2"];
//    [back addSubview:imgBut];
    
    UIView *fg1 = [[UIView alloc]initWithFrame:CGRectMake(22, 109.5, Width - 44, 1)];
    fg1.backgroundColor = COLOR2(241);
    [back addSubview:fg1];
    
    
     [UILabel initWithDFLable:CGRectMake(22, 70, 200, 30) :[UIFont systemFontOfSize:15*Width1] :COLOR2(51) :@"实际发货量" :back :0];
    
    
    
   self.unitLab = [UILabel initWithDFLable:CGRectMake(Width - 35, 70, 20, 30) :[UIFont systemFontOfSize:12*Width1] :COLOR2(51) :@"" :back :0];
    
//newUnit
    
    
//    UIView *fg2 = [[UIView alloc]initWithFrame:CGRectMake(22, 159.5, Width - 44, 1)];
//      fg2.backgroundColor = COLOR2(241);
//      [back addSubview:fg2];
    
    
    self.numTF = [[UITextField alloc]initWithFrame:CGRectMake(Width - 190, 70, 150, 30)];
    self.numTF.font = [UIFont systemFontOfSize:11];
    self.numTF.placeholder = @"请输入实际发货量";
    ...
    NSDictionary *attrs = @{NSFontAttributeName:[UIFont systemFontOfSize:15*Width1]};
     ...
     [UILabel initWithDFLable:CGRectMake(22, 130, width, 20) :[UIFont systemFontOfSize:15*Width1] :COLOR2(51) :@"请上传发货凭证" :back :0];
    
    
    
     [UILabel initWithDFLable:CGRectMake(width + 25, 130, Width, 20) :[UIFont systemFontOfSize:11] :COLOR2(153) :@"请保证凭证图片完整、清晰可见" :back :0];
    

    
    self.contImageBut = [UIButton initWithFrame:CGRectMake((Width - 190)/2, 170, 190, 120) :@"发货凭证"];
    ...
    [back addSubview:self.contImageBut];
        ...
        self.colseBut = [UIButton initWithFrame:CGRectMake((Width - 190)/2 + 170, 170, 20, 20) :@"关闭"];
    ...
    [UILabel initWithDFLable:CGRectMake((Width - 190)/2, 300, 190, 20) :[UIFont systemFontOfSize:12] :COLOR2(51) :@"点击拍照/上传发货凭证" :back :1];
    
    
    
     [UILabel initWithDFLable:CGRectMake(0, back.frame.size.height - 130, Width, 20) :[UIFont systemFontOfSize:12] :COLOR2(51) :@"请仔细阅读合同内容" :back :1];
        ...
        _textView = [[UITextView alloc] initWithFrame:CGRectMake((Width - widths)/2 + 5, back.frame.size.height - 100,widths + 10, 30)];
...
//   titleEdgeInsets
    ...
    self.selectBut = [UIButton initWithFrame:CGRectMake((Width - widths)/2 - 10, back.frame.size.height - 100, 30, 30) :@"选中"];
    ...
    UIButton *suppBut = [UIButton initWithFrame:CGRectMake(20, back.frame.size.height - 60, Width - 40, 40) :@"提交" :18*Width1];
...
//      [mp startLocationWithShippingNoteInfos:arr listener:^(id  _Nonnull model, NSError * _Nonnull error) {
////          result//结果
////          waybillId 运单
//          [AFN_DF POST:@"/tsmanage/waybill/deliverSDK" Parameters:@{@"result":@"0",@" waybillId":[NSString stringWithFormat:@"%@",self.dic[@"waybillId"]]} success:^(NSDictionary *responseObject) {
//
...
//      }];
    ...
    NSDictionary *dic = @{
        ...
        @"actualSend":self.numTF.text,
        @"waybillId":self.dic[@"waybillId"],
    };
    
    
    [AFN_DF POST:@"/tsmanage/waybill/deliver" Parameters:dic File:@[@"file"] ImageArr:@[self.img] ContVC:[AFN_DF topViewController] success:^(NSDictionary *responseObject) {
...
-(void)clanAction{
    ...
    if ([self.canlCode isEqualToString:@"1"]) {
