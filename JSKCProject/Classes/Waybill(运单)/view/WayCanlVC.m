...
-(void)setUI{
    ...
    self.viewVC = [[UIView alloc]initWithFrame:CGRectMake((Width - 250)/2, Height/2 - 112.5, 250, 225)];
    ...
    [UILabel initWithDFLable:CGRectMake(0, 120, self.viewVC.frame.size.width, 20) :[UIFont systemFontOfSize:15*Width1] :[UIColor blackColor] :@"确定删除此运单吗?" :self.viewVC :1];
