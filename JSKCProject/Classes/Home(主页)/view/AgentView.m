...
//
   ...
   [UILabel initWithDFLable:CGRectMake(0,120, Width - 132, 30) :[UIFont systemFontOfSize:20*Width1] :COLOR2(51) :@"未绑银行卡" :img :1];
    ...
    UIButton *endBut = [UIButton initWithFrame:CGRectMake(24, 240,img.frame.size.width - 48, 38) :@"立即绑卡" :17*Width1];
    endBut.backgroundColor = [UIColor redColor];
    endBut.layer.cornerRadius = 4;
    [endBut addTarget:self action:@selector(bankAction) forControlEvents:(UIControlEventTouchUpInside)];
...
-(void)bankAction{
    ...
    [[AFN_DF topViewController].navigationController pushViewController:payvc animated:YES];
